...
from test import model_inference
from model import build_model, model_save
...
def model_train(inputs, blocks, args, sum_path='./output'):
    ...
    with tf.Session() as sess:
        ...
        for i in range(epoch):
            ...
            if (i + 1) % args.save == 0:
                model_save(sess, global_steps, 'ST-GCN')
        writer.close()
